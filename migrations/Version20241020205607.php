 ...
 */
final class Version20241020205607 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE categoria ADD atualizado_em DATETIME NOT NULL, ADD criado_em DATETIME NOT NULL');
        $this->addSql('ALTER TABLE produto ADD valor_unitario INT NOT NULL, ADD atualizado_em DATETIME NOT NULL, CHANGE descricao descricao LONGTEXT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE categoria DROP atualizado_em, DROP criado_em');
        $this->addSql('ALTER TABLE produto DROP valor_unitario, DROP atualizado_em, CHANGE descricao descricao LONGTEXT NOT NULL');
    }
}
